...
function globalVariables() {
  ...
  var varArray = {
    spreadsheetId: '1_xiqrSe5kfnd1jSTApN-KGOK0_gS1ziqjZYZYWFF8TA', //** CHANGE !!!
    dataRage: 'ฐานข้อมูลพนักงาน!A1:J',                            //** CHANGE !!!
    idRange: 'ฐานข้อมูลพนักงาน!A2:A',                            //** CHANGE !!!
    lastCol: 'O',                                            //** CHANGE !!!
    insertRange: 'ฐานข้อมูลพนักงาน!A1:J1',                                   //** CHANGE !!!
    sheetID: '0'                                             //** CHANGE !!! 
  };
  return varArray;
}
...
function getRangeByID(id) {
  if (id) {
    ...
    for (var i = 0; i < idList.length; i++) {
      if (id == idList[i][0]) {
        return 'ฐานข้อมูลพนักงาน!A' + (i + 2) + ':' + globalVariables().lastCol + (i + 2);
      }
    }
  }
}
...
/**DataTable */
// function getAllData() {
//   var ss = SpreadsheetApp.openById("1_xiqrSe5kfnd1jSTApN-KGOK0_gS1ziqjZYZYWFF8TA")
//   var sheet = ss.getSheetByName("ฐานข้อมูลพนักงาน")
